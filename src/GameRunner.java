/*
    This is the starting point for the entire game.  It controls the number of low level game features such as:
    - frames per second (80 by default)
    - width and height of the game screen (800 x 600 by default)
    - full screen status (off by default)
    - whether the mouse cursor is visible (true by default)
...
public class GameRunner extends JFrame implements WindowListener, KeyListener, MouseListener, MouseMotionListener, Runnable
{
    ...
    //the number of frames per second our game gets
    private int fps = 120;
    ...
    //the number of pixels we want our game to take up
    ...
    public GameRunner() {
        ...
        makeMouseInvisible(true); //called to make the mouse invisible when the game starts
    }
    ...
    //try to switch resolutions - scale the screen if necessary
